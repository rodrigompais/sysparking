            ...
            <div class="widget-one">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-md-4 col-sm-12">
                        ...
                        <select wire:model="fabricante_id" class="form-control text-center">
                         ...
                         @error('fabricante_id') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="row">
...
<script type="text/javascript">
    var ss = $(".fabricanteselect").select2({
    tags: true,
});
</script>
