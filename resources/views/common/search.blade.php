<div class="row justify-content-between mb-4 mt-3">
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="input-group input-group-sm mb-4">
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-sm"><svg xmlns="http://www.w3.org/2000/svg" width="20"
    ...
    <div class="col-md-2 col-lg-2 col-sm-12 mt-2 mb-2 text-right mr-2">
        <button type="button" wire:click="doAction(2)" class="btn btn-outline-primary btn-rounded mb-2">
            Cadastrar
        </button>
    </div>
    @endcan
