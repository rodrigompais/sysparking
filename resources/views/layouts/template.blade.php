...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ url('dashboard') }}"><img alt="logo"
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <img src="{{asset('images/user.png')}}" class="img-fluid" alt="admin-profile">
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp"
                        ...
                        <div class="">
                            <div class="dropdown-item">
                                <a class="" href="{{ url('perfil') }}"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    <li class="menu single-menu ">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#topAccordion">
                            <li>
                                <a href="{{ url('dashboard') }}">Estatísticas</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="cashRegisters" data-parent="#topAccordion">
                            <li>
                                <a href="{{ url('vendas') }}"> Entradas e Saídas </a>
                            </li>

                            <li>
                                <a href="{{ url('ticketextraviados') }}"> Ticket Extraviados </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="cashRegisters" data-parent="#topAccordion">
                            <li>
                                <a href="{{ url('fechamentoscaixas') }}"> Fechamento de Caixa </a>
                            </li>

                            <li>
                                <a href="{{ url('movimientos') }}"> Movimentos </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="reports" data-parent="#topAccordion">
                            <li>
                                <a href="{{ url('vendasdiarias') }}"> Vendas Diárias </a>
                            </li>

                            <li>
                                <a href="{{ url('vendasporperiodo') }}"> Vendas por Data </a>
                            </li>
                            {{-- <li>
                                <a href="#"> Cotações </a>
                            </li> --}}
                            <li>
                                <a href="{{ url('vendasmensalistas') }}"> Vendas Mensalista</a>
                            </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="users" data-parent="#topAccordion">
                            ...
                            <li>
                                <a href="{{ url('fabricantes') }}"> Fabricante do Veiculo </a>
                            </li>
                            <li>
                                <a href="{{ url('modelos') }}"> Modelos de Veiculos </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="configurations" data-parent="#topAccordion">
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="#datatable" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Segurança <svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="datatable" data-parent="#datatable">
                                    ...
                                    <li>
                                        <a href="{{ url('permissao') }}"> Perfil de Acesso </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
    ...
    <script src="{{ asset('plugins/flatpickr/flatpickr_pt.js') }}"></script>
    ...
    {{-- @if ($type <= 0)
            <script type="text/javascript">
                toastr.warning("Por favor criar ao menos um tipo de Veiculo!")
            </script>   
        @endif --}}
    <script>
